...
const GoogleSignInButton = ({ onSuccess }: GoogleSignInButtonProps) => {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="glass-card-glow w-full p-4 flex items-center gap-4 text-left hover:border-primary/30 transition-all disabled:opacity-50"
    >
      ...
      <div className="flex-1">
        <p className="font-semibold text-foreground text-sm">Continue with Google</p>
